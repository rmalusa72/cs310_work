...
class Triangulate2{
    ...
    public static void main(String[] args){
        ...
        if (args.length >= 1){
            ...
            Triangulate2 t = new Triangulate2(n, print);
        }
    }
    ...
    public Triangulate2(int n, boolean print){
    ...
    // Given n, read the triangulations of the n-1-gon from file, build up the triangulations of the n-gon, and write THEM to file
    public TreeSet<Triangulation> triangulate(int n, int last_size){
        ...
        try{
            ...
            // Write new_triangulations to file
            ...
            while (iter.hasNext()){
                write_triangulation = iter.next();
                writer.write(255);
                for(int i=0; i<n; i++){
                    writer.write(255);
                    for(int j=0; j<write_triangulation.vertices[i].length; j++){
                        writer.write(write_triangulation.vertices[i][j]);
                    }
                    writer.write(255);
                }
                writer.write(255);
